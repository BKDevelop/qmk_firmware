...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_B, KC_LCTL, KC_Z, KC_X , KC_C   , KC_V, KC_H, SYM,     FKEYS  , KC_LGUI, KC_RBRC, KC_QUOT, KC_COMM, KC_DOT, KC_SLSH, KC_RALT,
                         LT(_FUNCTION, KC_ESC), KC_LALT, KC_N, KC_SPC, KC_M,        KC_CAPS , KC_ENT , KC_LBRC, NAV  , QWERTY
    ),
